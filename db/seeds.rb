...
u2 = User.create! name: "Chloé", description: "I love skiing and meeting people who have positive vibes!", hobbies: "cooking, travelling", level: "intermediate", car: false, email: "sauratchloe@gmail.com", password: "password123", picture: "https://avatars1.githubusercontent.com/u/55254804?v=4"
...
Rating.create!(user: u1, rating: 5, review: "Amandine is very nice, she show me how to ski on one foot. I would love to have another day with her")
Rating.create!(user: u2, rating: 4, review: "I had a amazing day with Chloe, we laughed so much! She is nice and punctual")
Rating.create!(user: u3, rating: 5, review: " Ryan is a very good teacher, patient and diplomat. He had a professional level but he is happy to share his knowledge")
Rating.create!(user: u4, rating: 4, review: "Charlotte is so fun! The day with her was really rythmed by sport time and fun time.")
Rating.create!(user: u5, rating: 4, review: "I went to Mont-Tremblant with Camille and we had a perfect day. She was happy to take my advices.")
Rating.create!(user: u6, rating: 5, review: "Stephane is a very enthusiastic guy! We discovered ")
Rating.create!(user: u7, rating: 4)

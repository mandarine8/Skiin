...
u1 = User.create! name: "Amandine", description: "I started skiing when I was 2 years old in French Alps, I really enjoy the snow and the winter", hobbies: "travelling, knitting", car: true, level: "expert", email: "caramandine@gmail.com", password: "password123", picture: "https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/rdw8huo8s0zfs5wvdzcl.jpg"
...
s25 = Skivent.create!(
 ...
 s26 = Skivent.create!(
  ...
  number_of_place: 1,
  car: false,
  description: "I want to discover Saint-Sauveur's slopes! Just to let you know, I am a snowboarder but I am totally open to have fun with skiers! Departure from Montreal.",
  resort: r4,
  user: u5,

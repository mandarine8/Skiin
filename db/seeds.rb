...
s7 = Skivent.create!(
  title: "Snowboarding with my cutie cat",
  date: Date.new(2019,12,14),
  level: "Intermediate",
  number_of_place: 3,
  car: true,
